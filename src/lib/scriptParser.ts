...
export function buildFullScriptFromSegments(
  ...
  const segments: Segment[] = [
    ...
    { id: 'article4', topic: selectedArticles?.['article4']?.topic || topics[0], content: segmentContents.article4 },
    { id: 'article5', topic: selectedArticles?.['article5']?.topic || topics[1], content: segmentContents.article5 },
