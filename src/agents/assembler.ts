...
export function createAssembler(): AgentFn {
  return async (ctx, onReasoningChunk) => {
    ...
    const segments: Segment[] = [
      ...
      { id: 'article4', topic: selectedMap['article4']?.topic || sessionConfig.content.topics[0], content: allSegments.article4 },
      { id: 'article5', topic: selectedMap['article5']?.topic || sessionConfig.content.topics[1], content: allSegments.article5 },
